...
# ╔═╡ 8eee0250-bd98-11ec-2c92-c3b970d95fe2
begin
	using Graphs
...
# ╔═╡ 6c1c9724-c9d8-475e-b1db-40333c969dd6
md"""
...
# ╔═╡ ab6e1f92-d225-4865-809e-e9303f105dcd
md"""
Number of files:
...
md"""
File one: $(@bind file1 FilePicker())
"""

# ╔═╡ aef75063-28f9-485e-8e67-61a4192ad92c
md"""
File two: $(@bind file2 FilePicker())
"""
...
colors = distinguishable_colors(number_of_communities + 1)
...
gplot(graphs[g_i], nodesize=20, layout=layout, nodelabel=1:nv(graphs[g_i]), nodefillc=colors1)

# ╔═╡ 392d4f0b-0239-4770-86a5-494ddd784266
gplot(graphs[g_i], nodesize=20, layout=layout, nodelabel=1:nv(graphs[g_i]), nodefillc=colors2)
